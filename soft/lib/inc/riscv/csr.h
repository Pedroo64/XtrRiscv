...
#define MCAUSE_MACHINE_ECALL 			9

#define MCAUSE_USER_SOFTWARE	        0
#define MCAUSE_SUPERVISOR_SOFTWARE	    1
#define MCAUSE_HYPERVISOR_SOFTWARE	    2
#define MCAUSE_MACHINE_SOFTWARE	        3
#define MCAUSE_USER_TIMER	            4
#define MCAUSE_SUPERVISOR_TIMER	        5
#define MCAUSE_HYPERVISOR_TIMER	        6
#define MCAUSE_MACHINE_TIMER	        7
#define MCAUSE_USER_ENVIRONNEMENT_CALL	8
#define MCAUSE_SUPERVISOR_EXTERNAL	    9
#define MCAUSE_HYPERVISOR_EXTERNAL	    10
#define MCAUSE_MACHINE_EXTERNAL	        11
...
#define MIDELEG_MACHINE_SOFTWARE        (1 << 3)
#define MIDELEG_MACHINE_TIMER           (1 << 7)
#define MIDELEG_MACHINE_EXTERNAL        (1 << 11)
